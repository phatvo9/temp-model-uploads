...
class MyRunner(ModelClass):
  ...
  def load_model(self):
    ...
    server_args = {'modalities': ['text'], 'backend': 'turbomind', 'cache_max_entry_count': 0.9, 'tensor_parallel_size': 1, 'max_prefill_token_num': 4096, 'dtype': 'auto', 'quantization_format': None, 'quant_policy': 0, 'chat_template': None, 'max_batch_size': 16, 'device': 'cuda', 'server_name': '0.0.0.0', 'server_port': 23333, 'checkpoints': 'unsloth/Llama-3.2-1B-Instruct'}
